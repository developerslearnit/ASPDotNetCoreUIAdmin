#pragma checksum "C:\dev\WebApp\DotNetCoreUIAdmin\DotNetCoreUIAdmin\Views\component\fontawesome.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "417fab80527f9bdea07a7c7a3f487961712aa761"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_component_fontawesome), @"mvc.1.0.view", @"/Views/component/fontawesome.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/component/fontawesome.cshtml", typeof(AspNetCore.Views_component_fontawesome))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"417fab80527f9bdea07a7c7a3f487961712aa761", @"/Views/component/fontawesome.cshtml")]
    ...
    public class Views_component_fontawesome : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 2 "C:\dev\WebApp\DotNetCoreUIAdmin\DotNetCoreUIAdmin\Views\component\fontawesome.cshtml"
  
    ViewData["Title"] = "Fontawesome";

#line default
#line hidden
            BeginContext(49, 177744, true);
            WriteLiteral(@"
...
<div class=""animated fadeIn"">
 ...
 ");
        ...
        ");
            WriteLiteral(@"            <br>free-code-camp
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
     ...
     ");
            ...
            WriteLiteral(@"ass=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa f");
            WriteLiteral(@"a-thermometer-2 fa-lg mt-4""></i>
                    <br>thermometer-2
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                ");
            WriteLiteral(@"    <br>thermometer-full
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <");
            WriteLiteral(@"i class=""fa fa-times-rectangle-o fa-lg mt-4""></i>
    ...
    <div class=""card"" id=""new"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
         ");
            WriteLiteral(@"           <i class=""fa fa-codiepie fa-lg mt-4""></i>
                    <br>codiepie
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-stop-circle-o fa-lg mt-");
            WriteLiteral(@"4""></i>
                    <br>stop-circle-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
 ...
 ");
            ...
            WriteLiteral(@"at fa-lg mt-4""></i>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=");
            WriteLiteral(@"""fa fa-bar-chart fa-lg mt-4""></i>
                    <br>bar-chart
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
      ");
            WriteLiteral(@"              <i class=""fa fa-battery-1 fa-lg mt-4""></i>
                    <br>battery-1
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-ba");
            WriteLiteral(@"ttery-empty fa-lg mt-4""></i>
                    <br>battery-empty
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
           ...
           ");
            WriteLiteral(@"         <br>bed
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
 ");
            WriteLiteral(@"                   <i class=""fa fa-bicycle fa-lg mt-4""></i>
                    <br>bicycle
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"br>bolt
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ");
            WriteLiteral(@"        <i class=""fa fa-bug fa-lg mt-4""></i>
                    <br>bug
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
      ...
      ");
            ...
            WriteLiteral(@"iv class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
               ");
            WriteLiteral(@"     <i class=""fa fa-car fa-lg mt-4""></i>
                    <br>car
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-ca");
            WriteLiteral(@"rt-arrow-down fa-lg mt-4""></i>
                    <br>cart-arrow-down
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    ");
            WriteLiteral(@"            <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                 ");
            WriteLiteral(@"   <i class=""fa fa-circle-o fa-lg mt-4""></i>
                    <br>circle-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
...
");
            ...
            WriteLiteral(@"    <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=");
            WriteLiteral(@"""fa fa-exchange fa-lg mt-4""></i>
                    <br>exchange
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-external-link-square fa-lg mt-4""");
            WriteLiteral(@"></i>
       ...
       ");
            ...
            WriteLiteral(@" fa-lg mt-4""></i>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    ...
                    <br");
            WriteLiteral(@">fire-extinguisher
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
      ...
      ");
            WriteLiteral(@"          <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""f");
            WriteLiteral(@"a fa-futbol-o fa-lg mt-4""></i>
                    <br>futbol-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""");
            WriteLiteral(@"fa fa-gift fa-lg mt-4""></i>
                    <br>gift
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
          ...
          ");
            ...
            WriteLiteral(@"r>hdd-o
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
      ");
            WriteLiteral(@"              <i class=""fa fa-home fa-lg mt-4""></i>
                    <br>home
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
...
");
            ...
            WriteLiteral(@"col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ");
            WriteLiteral(@"                  <i class=""fa fa-laptop fa-lg mt-4""></i>
                    <br>laptop
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-level-up fa-lg mt-4""");
            WriteLiteral(@"></i>
                    <br>level-up
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-magnet fa-lg mt-4");
            WriteLiteral(@"""></i>
                    <br>magnet
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
        ...
        ");
            ...
            WriteLiteral(@"div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
              ");
            WriteLiteral(@"      <i class=""fa fa-paper-plane-o fa-lg mt-4""></i>
                    <br>paper-plane-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"    <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-plus-square-o fa-lg m");
            WriteLiteral(@"t-4""></i>
                    <br>plus-square-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"s=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-refres");
            WriteLiteral(@"h fa-lg mt-4""></i>
                    <br>refresh
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=");
            WriteLiteral(@"""fa fa-reply-all fa-lg mt-4""></i>
                    <br>reply-all
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    ");
            WriteLiteral(@"            <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i ");
            WriteLiteral(@"class=""fa fa-share-square-o fa-lg mt-4""></i>
                    <br>share-square-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"-cart
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
              ");
            WriteLiteral(@"      <i class=""fa fa-smile-o fa-lg mt-4""></i>
                    <br>smile-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i cla");
            WriteLiteral(@"ss=""fa fa-sort-amount-asc fa-lg mt-4""></i>
                    <br>sort-amount-asc
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""");
            WriteLiteral(@"fa fa-sort-numeric-asc fa-lg mt-4""></i>
                    <br>sort-numeric-asc
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class");
            WriteLiteral(@"=""fa fa-spoon fa-lg mt-4""></i>
                    <br>spoon
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
          ...
          ");
            WriteLiteral(@"      <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa ");
            WriteLiteral(@"fa-tint fa-lg mt-4""></i>
                    <br>tint
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
");
            WriteLiteral(@"                    <i class=""fa fa-toggle-right fa-lg mt-4""></i>
                    <br>toggle-right
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"upload
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
     ");
            WriteLiteral(@"               <i class=""fa fa-video-camera fa-lg mt-4""></i>
                    <br>video-camera
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i cl");
            WriteLiteral(@"ass=""fa fa-wheelchair fa-lg mt-4""></i>
                    <br>wheelchair
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""hand"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-hand-");
            WriteLiteral(@"lizard-o fa-lg mt-4""></i>
                    <br>hand-lizard-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ...
  ");
    ...
    <div class=""card"" id=""transportation"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@"sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class");
            WriteLiteral(@"=""fa fa-rocket fa-lg mt-4""></i>
                    <br>rocket
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-ship fa-lg mt-4""></i>
    ...
    <div class=""card"" id=""file-type"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@"lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ");
            WriteLiteral(@"                <i class=""fa fa-file-pdf-o fa-lg mt-4""></i>
                    <br>file-pdf-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-file-photo-o fa-lg mt-4""></i>
    ...
    <div class=""card"" id=""form-control"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@"d-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-minus-square-o fa-lg mt");
            WriteLiteral(@"-4""></i>
                    <br>minus-square-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
        ...
        <div class=""card-body"">
           ...
           ");
            WriteLiteral(@"         <br>btc
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i clas");
            WriteLiteral(@"s=""fa fa-gbp fa-lg mt-4""></i>
                    <br>gbp
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
        ");
            WriteLiteral(@"            <i class=""fa fa-ruble fa-lg mt-4""></i>
                    <br>ruble
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    ");
            ...
            WriteLiteral(@"t-alt
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
      ");
            WriteLiteral(@"              <i class=""fa fa-paste fa-lg mt-4""></i>
                    <br>paste
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"<div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-underline fa-lg mt-");
            WriteLiteral(@"4""></i>
                    <br>underline
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""directional"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-angle-doubl");
            WriteLiteral(@"e-left fa-lg mt-4""></i>
  ...
  ");
            ...
            WriteLiteral(@">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i");
            WriteLiteral(@" class=""fa fa-arrows-h fa-lg mt-4""></i>
                    <br>arrows-h
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-arrows-v fa-lg mt-4""></i>
 ...
 ");
            ...
            WriteLiteral(@"v>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
     ");
            WriteLiteral(@"               <i class=""fa fa-hand-o-right fa-lg mt-4""></i>
                    <br>hand-o-right
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-hand-o-up fa-lg mt-4""></i>
            ...
            WriteLiteral(@"fa-lg mt-4""></i>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    ...
                    <br>toggle-up
                    <s");
            WriteLiteral(@"pan class=""text-muted"">(alias)</span>
                </div>
            </div>
        </div>
    </div>
    <div class=""card"" id=""video-player"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@"
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i clas");
            WriteLiteral(@"s=""fa fa-pause-circle fa-lg mt-4""></i>
                    <br>pause-circle
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-pause-circle-o fa-lg mt-4""></i>
    ...
    <div class=""card"" id=""brand"">
        ...
        <div class=""card-body"">
            <div class=""alert alert-warning"">
                ...
                </h4> Apparently, Adblock Plus can remove Font Awesome brand icons with their ""Remove Social Media Buttons"" setting. We will not use hacks to force them to display. Please
            ...
            WriteLiteral(@"col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
");
            WriteLiteral(@"                    <i class=""fa fa-black-tie fa-lg mt-4""></i>
                    <br>black-tie
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-bluetooth fa-lg mt-4""></i>
...
");
            ...
            WriteLiteral(@"-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    ...
                    <");
            WriteLiteral(@"br>connectdevelop
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ...
  ");
            ...
            WriteLiteral(@"v>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i clas");
            WriteLiteral(@"s=""fa fa-foursquare fa-lg mt-4""></i>
                    <br>foursquare
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"r>ioxhost
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
");
            WriteLiteral(@"                    <i class=""fa fa-linkedin fa-lg mt-4""></i>
                    <br>linkedin
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ...
  ");
            ...
            WriteLiteral(@"iv class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                  ");
            WriteLiteral(@"  <i class=""fa fa-reddit-square fa-lg mt-4""></i>
                    <br>reddit-square
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
...
");
            WriteLiteral(@"                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
           ");
            WriteLiteral(@"         <i class=""fa fa-slack fa-lg mt-4""></i>
                    <br>slack
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-twitter fa-lg mt-4""><");
            WriteLiteral(@"/i>
                    <br>twitter
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"ol-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-whatsap");
            WriteLiteral(@"p fa-lg mt-4""></i>
                    <br>whatsapp
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    ");
            ...
            <div class=""alert alert-success mt-4"">
                <ul class=""margin-bottom-none padding-left-lg"">
                    <li>All brand icons are trademarks o");
            WriteLiteral(@"f their respective owners.</li>
    ...
    <div class=""card"" id=""medical"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-heart fa-lg mt-4""");
            WriteLiteral(@"></i>
                    <br>heart
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
