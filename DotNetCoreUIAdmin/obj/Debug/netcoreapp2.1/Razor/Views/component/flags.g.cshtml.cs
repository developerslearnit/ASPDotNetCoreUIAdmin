#pragma checksum "C:\dev\WebApp\DotNetCoreUIAdmin\DotNetCoreUIAdmin\Views\component\flags.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "86b5f8ea77a9cbac4d1b44ad30d4fe14053a6b32"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_component_flags), @"mvc.1.0.view", @"/Views/component/flags.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/component/flags.cshtml", typeof(AspNetCore.Views_component_flags))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"86b5f8ea77a9cbac4d1b44ad30d4fe14053a6b32", @"/Views/component/flags.cshtml")]
    ...
    public class Views_component_flags : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 2 "C:\dev\WebApp\DotNetCoreUIAdmin\DotNetCoreUIAdmin\Views\component\flags.cshtml"
  
    ViewData["Title"] = "Flags";

#line default
#line hidden
            BeginContext(43, 54721, true);
            WriteLiteral(@"
...
<div class=""animated fadeIn"">
    <div class=""card"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@" h1"" id=""am"" title=""am""></i>
    ...
    ");
            WriteLiteral(@"                <div>flag-icon-bf</div>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i cl");
            WriteLiteral(@"ass=""flag-icon flag-icon-bl h1"" id=""bl"" title=""bl""></i>
            ...
            WriteLiteral(@"/div>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""flag-icon flag-icon-cd h1"" id");
            WriteLiteral(@"=""cd"" title=""cd""></i>
   ...
   ");
           ...
           ");
            WriteLiteral(@"         <div>flag-icon-cx</div>
                </div>
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""fl");
            WriteLiteral(@"ag-icon flag-icon-dk h1"" id=""dk"" title=""dk""></i>
...
");
            WriteLiteral(@"                </div>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""flag-icon flag-icon-fm h1"" id=""fm"" t");
            WriteLiteral(@"itle=""fm""></i>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
     ");
            WriteLiteral(@"               <i class=""flag-icon flag-icon-gd h1"" id=""gd"" title=""gd""></i>
          ...
          ");
            WriteLiteral(@"      <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                  ...
                  ");
            WriteLiteral(@"  <div>flag-icon-gp</div>
                </div>
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""flag-icon");
            WriteLiteral(@" flag-icon-gu h1"" id=""gu"" title=""gu""></i>
       ...
       ");
            WriteLiteral(@"         </div>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""flag-icon flag-icon-io h1"" id=""io"" title=""i");
            WriteLiteral(@"o""></i>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
            ");
            WriteLiteral(@"        <i class=""flag-icon flag-icon-je h1"" id=""je"" title=""je""></i>
            ...
            WriteLiteral(@"con-kz h1"" id=""kz"" title=""kz""></i>
            ...
            WriteLiteral(@"
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                   ");
            WriteLiteral(@" <i class=""flag-icon flag-icon-mk h1"" id=""mk"" title=""mk""></i>
            ...
            WriteLiteral(@"h1"" id=""my"" title=""my""></i>
     ...
     ");
            WriteLiteral(@"               <div>flag-icon-om</div>
                </div>
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i cla");
            WriteLiteral(@"ss=""flag-icon flag-icon-ph h1"" id=""ph"" title=""ph""></i>
            ...
            WriteLiteral(@"div>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""flag-icon flag-icon-ru h1"" id=");
            WriteLiteral(@"""ru"" title=""ru""></i>
    ...
    ");
            ...
            ");
            WriteLiteral(@"        <div>flag-icon-sn</div>
                </div>
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""fla");
            WriteLiteral(@"g-icon flag-icon-sv h1"" id=""sv"" title=""sv""></i>
 ...
 ");
            WriteLiteral(@"               </div>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""flag-icon flag-icon-to h1"" id=""to"" ti");
            WriteLiteral(@"tle=""to""></i>
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
      ");
            WriteLiteral(@"              <i class=""flag-icon flag-icon-tz h1"" id=""tz"" title=""tz""></i>
           ...
           ");
            WriteLiteral(@"     <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                   ...
                   ");
            WriteLiteral(@" <div>flag-icon-ve</div>
                </div>
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                ...
                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    <i class=""flag-icon ");
            WriteLiteral(@"flag-icon-wf h1"" id=""wf"" title=""wf""></i>
